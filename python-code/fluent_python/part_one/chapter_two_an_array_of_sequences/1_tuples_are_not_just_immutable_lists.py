...
if __name__ == '__main__':
    ...
    2. Performance: A tuple uses less memory than a list of the same length, and it allows Python to do some optimizations.
    """
    ...
    builds the list
    2. Given a tuple r, tuple(t) directly returns a reference to the same t. Given a list l,
