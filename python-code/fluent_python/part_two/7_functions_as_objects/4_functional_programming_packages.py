...
if __name__ == '__main__':
    ...
    metro_areas = [Metropolis(n, c, p, LatLon(lat, lon)) for n, c, p, (lat, lon) in metro_data]
    ...
    methods_in_the_operator_package = [name for name in dir(operator) if not name.startswith('_')]
